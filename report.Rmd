...
Atmospheric Administration's (NOAA) storm database. Its purpose analysis is to
determine which weather events have the greatest impact on population health and
the economy. That which follows provides and exact, reproducible steps in data
